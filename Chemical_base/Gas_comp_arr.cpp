...
#include "Gas_comp_arr.h"

Gas_comp_arr::Gas_comp_arr() {
    create_gas_comp();
}

std::vector<Gas_component> Gas_comp_arr::get_arr() const {
    return m_array_gas_component;
}

void Gas_comp_arr::create_gas_comp() {
    // Метан
    ...
    m_array_gas_component.push_back(methane);
    ...
    m_array_gas_component.push_back(ethan);
    ...
    m_array_gas_component.push_back(propane);
    ...
    m_array_gas_component.push_back(n_butane);
    ...
    m_array_gas_component.push_back(methylpropane_2);
    ...
    m_array_gas_component.push_back(n_pentane);
    ...
    m_array_gas_component.push_back(methylbutane_2);
    ...
    m_array_gas_component.push_back(dimethylpropane_2_2);
    ...
    m_array_gas_component.push_back(n_hexane);
    ...
    m_array_gas_component.push_back(methylpentane_2);
    ...
    m_array_gas_component.push_back(methylpentane_3);
    ...
    m_array_gas_component.push_back(dimethylbutane_2_2);
    ...
    m_array_gas_component.push_back(dimethylbutane_2_3);
    ...
    m_array_gas_component.push_back(n_heptane);
    ...
    m_array_gas_component.push_back(n_octane);
    ...
    m_array_gas_component.push_back(n_nonan);
    ...
    m_array_gas_component.push_back(n_dean);
    ...
    m_array_gas_component.push_back(ethylene);
    ...
    m_array_gas_component.push_back(propylene);
    ...
    m_array_gas_component.push_back(butene_1);
    ...
    m_array_gas_component.push_back(cis_2_butene);
    ...
    m_array_gas_component.push_back(trans_2_buten);
    ...
    m_array_gas_component.push_back(methylpropene_2);
    ...
    m_array_gas_component.push_back(penten_1);
    ...
    m_array_gas_component.push_back(propadiene);
    ...
    m_array_gas_component.push_back(butadiene_1_2);
    ...
    m_array_gas_component.push_back(butadiene_1_3);
    ...
    m_array_gas_component.push_back(acethylene);
    ...
    m_array_gas_component.push_back(cyclopentane);
    ...
    m_array_gas_component.push_back(methylcyclopentane);
    ...
    m_array_gas_component.push_back(ethylcyclopentan);
    ...
    m_array_gas_component.push_back(cyclohexane);
    ...
    m_array_gas_component.push_back(methylcyclohexane);
    ...
    m_array_gas_component.push_back(ethylcyclohexane);
    ...
    m_array_gas_component.push_back(benzol);
    ...
    m_array_gas_component.push_back(toluol);
    ...
    m_array_gas_component.push_back(ethylbenzol);
    ...
    m_array_gas_component.push_back(xylol_o);
    ...
    m_array_gas_component.push_back(methanol);
    ...
    m_array_gas_component.push_back(methanethiol);
    ...
    m_array_gas_component.push_back(hydrogen);
    ...
    m_array_gas_component.push_back(water);
    ...
    m_array_gas_component.push_back(hydrogen_sulfide);
    ...
    m_array_gas_component.push_back(ammonia);
    ...
    m_array_gas_component.push_back(hydrogen_cyanide);
    ...
    m_array_gas_component.push_back(carbon_monoxide);
    ...
    m_array_gas_component.push_back(carbonyl_sulfide);
    ...
    m_array_gas_component.push_back(carbon_disulfide);
    ...
    m_array_gas_component.push_back(helium);
    ...
    m_array_gas_component.push_back(neon);
    ...
    m_array_gas_component.push_back(argon);
    ...
    m_array_gas_component.push_back(nitrogen);
    ...
    m_array_gas_component.push_back(oxygen);
    ...
    m_array_gas_component.push_back(carbon_dioxide);
    ...
    m_array_gas_component.push_back(sulfur_dioxide);
    ...
    m_array_gas_component.push_back(nitrogen_monoxide);
    ...
    m_array_gas_component.push_back(krypton);
    ...
    m_array_gas_component.push_back(xenon);
    ...
    m_array_gas_component.push_back(air);
}

Gas_comp_arr::~Gas_comp_arr() = default;
